...
import Background2 from "../../assets/CadastroAssets/Background2.png";
        ...
        >
          <div className="Card-Left">
            <div className="card-title">
              <Link to="/">
                <img className="logo-cadastro" src={Logo} alt="" />
              </Link>
            ...
            <img className="Estetoscopio-img" src={Estetoscopio} alt="" />
          </div>
